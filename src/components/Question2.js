  ...
  return (
    <div className="question">
      ...
      <ul className="question-text">
          <li>Plānotu programmatūras arhitektūru: Klašu diagrammas palīdz izstrādātājiem saprast un plānot, kā dažādas klases un objekti mijiedarbosies savā starpā.</li>
